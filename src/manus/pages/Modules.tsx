...
const MODULES_DATA = [
  { number: 1, title: "The path to a COLOURFUL life", tagline: "Discover how to use the same intricate colour techniques designers rely on, broken down into simple steps, to create a unique space with a clear, intentional outcome.", lessonCount: 7, available: true, courseId: 1, thumbnail: "/manus-storage/course-colourful_0478abef.png" },
  { number: 2, title: "The sacred BEDROOM", tagline: "Create a bedroom that feels intentional, not accidental — learn the overlooked techniques that designers use to bring everything together.", lessonCount: 6, available: true, comingSoon: true, thumbnail: "/manus-storage/course-bedroom_f6b15eed.png" },
  { number: 3, title: "The alchemic KITCHEN", tagline: "The most expensive space to get wrong is your kitchen — discover the intentional design choices that increase value and make everyday life easier.", lessonCount: 8, available: true, comingSoon: true, thumbnail: "/manus-storage/course-kitchen_93724e97.png" },
  { number: 4, title: "The elemental BATHROOM", tagline: "When every element is permanent, every decision matters — learn how to design a bathroom that feels beautiful, functions effortlessly, and adds lasting value to your home.", lessonCount: 6, available: false, comingSoon: true, thumbnail: "/manus-storage/course-bathroom_fed5d184.png" },
  { number: 5, title: "The soulful LIVING ROOM", tagline: "Furniture is the most consequential decision in a living room — and the most misunderstood. Discover how designers approach every element so the whole room finally makes sense.", lessonCount: 7, available: true, comingSoon: true, thumbnail: "/manus-storage/course-living-room_fec0ad04.png" },
  { number: 6, title: "The crafted DINING ROOM", tagline: "A dining room should be beautiful enough to linger in and practical enough to live in. You don't have to choose between the two.", lessonCount: 3, available: true, comingSoon: true, thumbnail: "/manus-storage/course-dining-room_b319fb05.png" },
  { number: 7, title: "Catalyst WORKSPACE", tagline: "A home office shouldn't be an afterthought. Create a designated space that works for your life and looks considered on camera.", lessonCount: 4, available: true, comingSoon: true, thumbnail: "/manus-storage/course-workspace_ff50b0d7.png" },
  { number: 9, title: "Enchanted OUTDOORS", tagline: "Your outdoor space should be the most lived-in room in the house. Discover how to create an environment that's social, intentional, and well within reach.", lessonCount: 5, available: true, comingSoon: true, thumbnail: "/manus-storage/course-outdoors_879d59b7.png" },
  { number: 10, title: "Knowledgeable CHEAT SHEETS", tagline: "See your home the way a designer does — understanding light, proportion, styling and the invisible rules that make a space feel right.", lessonCount: 8, available: true, comingSoon: true, thumbnail: "/manus-storage/course-design_1ede2590.png" },
];
