-- RPC to let a certificate owner (or admin) toggle the public visibility
-- of their certificate by setting or clearing certificates.public_slug.
CREATE OR REPLACE FUNCTION public.set_certificate_visibility(
...
GRANT EXECUTE ON FUNCTION public.set_certificate_visibility(bigint, boolean) TO authenticated;