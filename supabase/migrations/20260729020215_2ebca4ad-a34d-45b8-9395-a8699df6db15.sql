...
BEGIN
  ...
  -- Bugfix: previous version selected "rnk" which doesn't exist on the returned
  -- row (the function exposes the column as "rank"). That raised
  -- "column rnk does not exist" and made this RPC 500 for every user, freezing
  -- the Alchemist Level card at "Calculating your XP…".
